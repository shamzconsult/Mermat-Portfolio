            ...
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-300 leading-relaxed max-w-2xl">
                  Leading provider of comprehensive contracting, merchandise trading, and human capacity development
                  services. Empowering individuals, institutions, and communities across Nigeria through excellence and
                  innovation.
                </p>
              </div>
              ...
              <div className="flex items-center space-x-8 pt-4">
                ...
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-5 w-5 text-green-400" />
                  <span className="text-gray-300">ISO Certified Operations</span>
                </div>
              </div>
            </div>
          </div>
